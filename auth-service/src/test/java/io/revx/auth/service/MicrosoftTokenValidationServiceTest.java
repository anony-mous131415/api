...
public class MicrosoftTokenValidationServiceTest {
  @Mock
  ...
  public void setUp() throws Exception {
    ...
    microsoftTokenValidationService.securityConstants = securityConstants;
  }
  ...
  public void testValidateTokenSuccess() throws Exception {
    ...
    mapResp.put("mail", "akhilesh");
    Gson builder = new GsonBuilder().create();
    mockRestTemplate(authenticationHeaderValue, builder.toJson(mapResp), HttpStatus.OK);
    UserInfoModel userInfoModel = microsoftTokenValidationService.validateToken(authenticationHeaderValue);
    assertNotNull(userInfoModel);
  }

  @Test
  public void testValidateTokenSuccessWhenSurname() throws Exception {
    String authenticationHeaderValue = "hAGDFBCVASGDFAS6534872TAFHGDAJcJKFVDBCV";
    Map<String, String> mapResp = new HashMap<String, String>();
    mapResp.put("surname", "akhilesh");
    Gson builder = new GsonBuilder().create();
    mockRestTemplate(authenticationHeaderValue, builder.toJson(mapResp), HttpStatus.OK);
    UserInfoModel userInfoModel = microsoftTokenValidationService.validateToken(authenticationHeaderValue);
    assertNotNull(userInfoModel);
  ...
  @Test
  public void testValidateTokenSuccessWhenDisplayName() throws Exception {
    String authenticationHeaderValue = "hAGDFBCVASGDFAS6534872TAFHGDAJcJKFVDBCV";
    Map<String, String> mapResp = new HashMap<String, String>();
    mapResp.put("displayName", "akhilesh");
    Gson builder = new GsonBuilder().create();
    mockRestTemplate(authenticationHeaderValue, builder.toJson(mapResp), HttpStatus.OK);
    UserInfoModel userInfoModel = microsoftTokenValidationService.validateToken(authenticationHeaderValue);
    assertNotNull(userInfoModel);
  ...
  public void testValidateTokenFailedWhenBadURI() throws Exception {
    String authenticationHeaderValue = "hAGDFBCVASGDFAS6534872TAFHGDAJcJKFVDBCV";
    securityConstants.setOffice365ApiUrl("htt://    googlr.com. . ...");
    mockRestTemplate(authenticationHeaderValue, null, HttpStatus.OK);
    UserInfoModel userInfoModel = microsoftTokenValidationService.validateToken(authenticationHeaderValue);
    assertNull(userInfoModel);
  }
