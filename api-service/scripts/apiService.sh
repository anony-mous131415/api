...
SLEEP_SECONDS=5
RETVAL=0
JAVA_OPTS="-server -Xms128m -Xmx12488m -XX:+UseG1GC -javaagent:/atom/dd-java-agent.jar -Ddd.profiling.enabled=true -Ddd.logs.injection=true -Ddd.service=api-service"
