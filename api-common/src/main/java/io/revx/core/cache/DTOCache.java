...
public class DTOCache extends CommonCache<BaseModel> {

  private static final Logger logger = LogManager.getLogger(DTOCache.class);

  private Map<String, String> fieldsAndMethodMap = null;

  public DTOCache(String name, Class<?> classTypeToCache) {
  ...
  public DTOCache(String name, Class<?> classTypeToCache, Long timeToExpire) {
  ...
  public List<BaseModel> getAll(Set<DashboardFilters> filters, List<String> sortOn)
  ...
  public List<BaseModel> getAll(String filter, List<String> sortOn, String dataType)
      throws UnsortableAttributeException {
    if (!cacheAvailable())
      return null;
  ...
  public void populate(Collection<BaseModel> data) {
    if (data == null) {
      return;
    }
