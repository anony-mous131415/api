...
public class RuleDTO implements Serializable {
	...
	private RuleComponentDTO ruleElement;
	
	
	private List<RuleDTO> ruleExpressionList;
  ...
  public String toString() {
    ...
    builder.append("RuleDTO [simpleExpr=").append(simpleExpr).append(", ruleElement=")
        .append(ruleElement).append(", ruleExpressionList=").append(ruleExpressionList)
        .append(", negate=").append(negate).append(", operator=").append(operator).append("]");
